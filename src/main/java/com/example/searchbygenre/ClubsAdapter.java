...
public class ClubsAdapter extends RecyclerView.Adapter<ClubsAdapter.ViewHolder>{
    ...
    public ClubsAdapter(List<Club> items, OnLongClickListener longClickListener, OnClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View todoView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_item_club, parent, false);
